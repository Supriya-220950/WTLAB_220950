...
// 0. Lab 7 OAuth State hook
$isOauth = isset($_SESSION['oauth_user']);
$oauthUser = $isOauth ? $_SESSION['oauth_user'] : null;
...
$rawUserName = $isOauth ? $oauthUser['name'] : "  dr. john doe  ";
        ...
        <div class="header">
            <div class="header-top">
                ...
                <div class="header-right">
                    <div class="user-widget" style="display:flex; flex-direction:column; align-items:center;">
                        <img src="<?php echo $isOauth ? $oauthUser['avatar'] : 'https://via.placeholder.com/50'; ?>" alt="User" class="user-avatar" style="<?php if($isOauth) echo 'border: 3px solid #4CAF50;'; ?>">
                        <span class="user-name"><?php echo $styledUserName; ?></span>
                        <?php if ($isOauth): ?>
                            <span style="font-size: 0.8rem; background-color: #e8f5e9; color: #2e7d32; padding: 2px 5px; border-radius: 4px; margin-top: 5px;">Authenticated via <?php echo $oauthUser['provider']; ?></span>
                            <a href="oauth_callback.php?action=logout" style="font-size: 0.8rem; color: #d32f2f; text-decoration: none; margin-top: 5px;">Logout</a>
                        <?php else: ?>
                            <a href="oauth_callback.php?action=login" style="font-size: 0.8rem; background-color: #4285F4; color: white; padding: 5px 10px; border-radius: 4px; text-decoration: none; margin-top: 5px;">Sign in with Google</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
