...
if (isset($_GET['oauth']) && $_GET['oauth'] === 'google') {
    $_SESSION['secure_user'] = ['name' => 'Dr. Google Mock', 'role' => 'OAuth User Logged In'];
}
...
$activeUser = $_SESSION['secure_user'];

// 0. Lab 7 OAuth hook (Overridden by Lab 8 Secure User)
$isOauth = true;
$oauthUser = ['name' => $activeUser['name'], 'avatar' => 'https://via.placeholder.com/50'];
// 0. Lab 7 OAuth hook
$oauthUser = ['name' => $activeUser['name'], 'avatar' => 'https://via.placeholder.com/50'];
// 1. PHP Variable Scope
$globalPatientCount = 150 + rand(10,50); // Global Variable
            ...
            <div class="header-top">
                ...
                <div class="header-right">
                    <div class="user-widget" style="display:flex; flex-direction:column; align-items:center;">
                        ...
                        <span class="user-name"><?php echo $styledUserName; ?> 
                        <br><span style="font-size:0.8rem; color:#1e3a8a;"><?php echo $activeUser['role']; ?></span></span>
                        <a href="dashboard.php?action=logout" style="font-size: 0.8rem; color: #d32f2f; text-decoration: none; margin-top: 5px;">Logout</a>
                    </div>
                </div>
            </div>
        </div>
